...
public class Algoritmo extends Applet implements ActionListener {
    ...
    public void init() {
        ...
        subpanel.add(new Label("Ingrese el valor de a:"));
        subpanel.add(new Label("Ingrese el valor de b:"));
        subpanel.add(new Label("Ingrese el valor de c:"));
